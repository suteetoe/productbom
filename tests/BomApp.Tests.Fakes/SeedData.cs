...
public static class SeedData
{
    ...
    public static readonly ErpSalesTransactionDto Sales_Day1_Doc1_PROD001 = new(
        new DateOnly(2024, 1, 15), "SO-2024-0001", "PROD-001", "สินค้า A (มี BOM)", 10m, "PCS", 1m, 1m, "WH-A", "SH-01");
    ...
    public static readonly ErpSalesTransactionDto Sales_Day1_Doc2_PROD001 = new(
        new DateOnly(2024, 1, 15), "SO-2024-0002", "PROD-001", "สินค้า A (มี BOM)", 5m, "BOX", 12m, 1m, "WH-B", "SH-02");
    ...
    public static readonly ErpSalesTransactionDto Sales_Day1_Doc1_PROD999 = new(
        new DateOnly(2024, 1, 15), "SO-2024-0001", "PROD-999", "สินค้าไม่มี BOM", 2m, "PCS", 1m, 1m, "WH-A", "SH-01");
    ...
    public static readonly ErpSalesTransactionDto Sales_Day2_Doc1_PROD002 = new(
        new DateOnly(2024, 1, 16), "SO-2024-0003", "PROD-002", "สินค้า B (มี BOM)", 20m, "KG", 1m, 1m, "WH-A", "SH-01");
}
