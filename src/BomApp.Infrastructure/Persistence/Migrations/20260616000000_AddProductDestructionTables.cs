...
namespace BomApp.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddProductDestructionTables : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                DROP TABLE IF EXISTS public.bom_product_destruction_detail;
                DROP TABLE IF EXISTS public.bom_product_destruction_pictures;
                DROP TABLE IF EXISTS public.bom_product_destruction;
                """);
        }
    }
}
