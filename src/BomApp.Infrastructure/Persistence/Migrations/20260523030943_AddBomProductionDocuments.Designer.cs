...
namespace BomApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260523030943_AddBomProductionDocuments")]
    partial class AddBomProductionDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BomApp.Domain.Entities.BomProduction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("bom_production", "public");
                });

            modelBuilder.Entity("BomApp.Domain.Entities.BomProductionDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("bom_production_detail", "public");
                });
            ...
            modelBuilder.Entity("BomApp.Domain.Entities.BomProductionDetail", b =>
                {
                    b.HasOne("BomApp.Domain.Entities.BomProduction", "Production")
                        .WithMany("Details")
                        .HasForeignKey("DocNo")
